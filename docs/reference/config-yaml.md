...
| `extra_paths` | list / empty | Up to three read grants for `deny-most`; an entry that resolves to the home directory, an ancestor of it, or a credential store the profile denies is logged at ERROR and dropped | Next turn |
